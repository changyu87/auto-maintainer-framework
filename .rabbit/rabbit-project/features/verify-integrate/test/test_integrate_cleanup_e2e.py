...
INTEGRATE is the single highest-stakes act-side state (DESIGN §3.7): it reads the
...
# ==========================================================================
# Behaviour: INTEGRATE manifest is {reads: [verdicts], writes:
# [integration_result], emits: [OK]} and conforms to the fsm-contracts shape.
# ==========================================================================
