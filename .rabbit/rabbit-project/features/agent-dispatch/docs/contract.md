...
```json
{
  "provides": {
    "files": [
      ...
      "render(envelope) -> structured-markdown prompt: inputs as derivative view; self-contained ## Handoff = embedded concrete example to mimic + write-to-file + one-line ack",
