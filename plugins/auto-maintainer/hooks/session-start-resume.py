...
the heartbeat *durable* across sessions (DESIGN §3.3.2 heartbeat bootstrap,
§3.3.4 RESTART_NEEDED -> SessionStart auto-resume) this hook re-arms the
in-session heartbeat on the next session whenever the durable loop-intent says
